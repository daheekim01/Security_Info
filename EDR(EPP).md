...
* **악성 코드 탐지**: 알려진 악성 코드 시그니처와 패턴을 바탕으로 실시간으로 악성 코드를 탐지합니다.
...
* EPP에서 제공하는 기능과 유사하지만, **서버 환경에 특화된 보호 기능**을 제공합니다.
  * 예시: **트렌드 마이크로** Deep Security (보안 솔루션), **SEP (Symantec Endpoint Protection)**
...
### **EPP(Endpoint Protection Platform) | 안티바이러스가 EDR의 서버백신 역할을 한다**
